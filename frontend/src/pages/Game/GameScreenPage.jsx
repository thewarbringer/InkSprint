...
import { getRandomWord } from "../../constants/quickDrawCategories.js";
...
export default function GameScreenPage() {
  ...
  const { confidence: modelConfidence, modelReady } = useQuickDrawPrediction({
    canvasRef,
    targetWord: word,
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex h-[420px] flex-col gap-3">
            ...
            <div className="flex-1">
              <GameCanvas ref={canvasRef} onConfidenceChange={setInkConfidence} locked={roundEnded.current} />
            </div>
          </div>
        </div>
